...
class TestXunitrptCls(unittest.TestCase):
    ...
    def test_class_level(self):
        self.cls_rptf = self.rpts.get_class_rpt()
        self.assertEqual(1, len(self.cls_rptf))
        expected_dict = {
        ...
        self.assertDictEqual(expected_dict, self.cls_rptf.get_cases(), "Class level accumulation failed")
        print("**Dump Class Level XUnit Report**\n{}".format(self.cls_rptf.dump()))
